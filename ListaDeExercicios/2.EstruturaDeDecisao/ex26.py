...
26. Um posto está vendendo combustíveis com a seguinte tabela de descontos:
    ...
    b) acima de 20 litros, desconto de 6% por litro. Escreva um algoritmo que leia o número de litros vendidos, o tipo de combustível (codificado da seguinte forma: 
